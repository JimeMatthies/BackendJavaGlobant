...
public class NIFServicio {
    ...
    public NIF crearNIF() {
        ...
        char verificador = LETRAS[(int)DNI%23];
        System.out.println(verificador);

        return new NIF(DNI, verificador);
    }

    public void mostrarNIF(NIF nn) {
        System.out.println("---------------------------------");
        System.out.println("Número de identificación Fiscal: ");
        System.out.println(nn.getDNI()+ "-" + nn.getVerificador());
    }
