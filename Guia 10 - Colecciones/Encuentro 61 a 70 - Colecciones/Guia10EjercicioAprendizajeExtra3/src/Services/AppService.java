...
public class AppService {
    ...
    public void LibraryApp() {
        //createFamousSingers();
        bs.addBook(new Book("The life-changing Magic of Tidying up", "Marie Kondo", 4, 1));
        bs.addBook(new Book("Someday, Someday, Maybe", "Lauren Graham", 5, 0));
        bs.addBook(new Book("Harry Potter and the Half-Blood Prince", "J. K. Rowling", 3, 3));
        bs.addBook(new Book("The Hobbit", "J. R. R. Tolkien", 1, 1));
        bs.addBook(new Book("The Alchemist", "Paulo Coelho", 2, 0));
        bs.showBooks();
        menu();
        int op = 0;
        do {
