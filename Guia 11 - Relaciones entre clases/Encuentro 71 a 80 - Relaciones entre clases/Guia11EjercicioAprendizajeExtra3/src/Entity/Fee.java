...
public class Fee {
    ...
    public Fee(Integer number, Double value, Boolean paid, LocalDate feeDueDate, String methodOfPayment) {
        this.number = number;
        this.value = value;
        this.paid = paid;
    ...
    public String toString() {
        return "Fee{" + "number=" + number + ", value=" + value + ", paid=" + paid + ", feeDueDate=" + feeDueDate + ", methodOfPayment=" + methodOfPayment + '}';
    }
