...
aleatoriamente (no se puede ubicar un espectador donde ya este ocupado el asiento).
Los espectadores serán ubicados de uno en uno y para ubicarlos tener en cuenta que sólo se podrá sentar a un 
espectador si tiene el dinero suficiente para pagar la entrada, si hay espacio libre en la sala y si tiene la edad 
requerida para ver la película. En caso de que el asiento este ocupado se le debe buscar uno libre.
Al final del programa deberemos mostrar la tabla, podemos mostrarla con la letra y numero de cada asiento 
o solo las X y espacios vacíos.
@author JimeM
 */
package guia11ejercicioaprendizajeextra2;

public class Guia11EjercicioAprendizajeExtra2 {

    public static void main(String[] args) {
        TheaterApp ca = new TheaterApp();
        //ca.createTheather();
        ca.loadTheater();
        ca.showTheater();
        ca.sellTickets();
