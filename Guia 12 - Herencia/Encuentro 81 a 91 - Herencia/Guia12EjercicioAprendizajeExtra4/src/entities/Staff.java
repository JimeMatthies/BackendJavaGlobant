...
public final class Staff extends Employee {
    ...
    public Staff(String section, Integer joiningYear, Integer officeNumber, String name, String lastname, String id, CivilStatus civilStatus) {
    ...
    public String toString() {
        return "Staff{" + "name=" + name + ", lastname=" + lastname + ", id=" + id + ", civilStatus=" + civilStatus + ", joiningYear=" + joiningYear + ", officeNumber=" + officeNumber + ", section=" + section + '}';
    }
