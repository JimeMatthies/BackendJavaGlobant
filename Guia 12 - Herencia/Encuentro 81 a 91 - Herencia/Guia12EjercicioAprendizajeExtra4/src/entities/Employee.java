...
public abstract class Employee extends Person {
    ...
    protected Integer joiningYear;
    protected Integer officeNumber;

    public Employee() {
    }

    public Employee(Integer joiningYear, Integer officeNumber, String name, String lastname, String id, CivilStatus civilStatus) {
    ...
    public String toString() {
        return "Employee{" + "name=" + name + ", lastname=" + lastname + ", id=" + id + ", civilStatus=" + civilStatus + ", joiningYear=" + joiningYear + ", officeNumber=" + officeNumber + '}';
    }
