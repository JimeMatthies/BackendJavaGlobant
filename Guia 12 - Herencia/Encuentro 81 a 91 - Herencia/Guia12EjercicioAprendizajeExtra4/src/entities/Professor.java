...
public final class Professor extends Employee {
    ...
    public Professor(String departament, Integer joiningYear, Integer officeNumber, String name, String lastname, String id, CivilStatus civilStatus) {
        super(joiningYear, officeNumber, name, lastname, id, civilStatus);
    ...
    public String toString() {
        return "Professor{" + "name=" + name + ", lastname=" + lastname + ", id=" + id + ", civilStatus=" + civilStatus + ", joiningYear=" + joiningYear + ", officeNumber=" + officeNumber + ", departament=" + departament + '}';
    }
