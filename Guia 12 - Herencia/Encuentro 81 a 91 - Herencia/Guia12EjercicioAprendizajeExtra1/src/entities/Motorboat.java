...
public class Motorboat extends Boat {
    ...
    public Motorboat(Integer hp, String registration, Integer loa, Integer manufactureYear) {
    ...
    public Integer calculateModule() {
        return super.calculateModule() + hp;
    }

    @Override
    public String toString() {
        return "Motorboat{" + "registration=" + registration + ", loa=" + loa + ", manufactureYear=" + manufactureYear + "hp=" + hp + '}';
    }
